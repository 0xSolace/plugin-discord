...
describe("Discord Messaging", () => {
	...
	describe("messageContainsMention", () => {
		it("should detect user mention", () => {
			expect(messageContainsMention("Hello <@123456789>!", "123456789")).toBe(
				true,
			);
		});
		...
		it("should return false for different user ID", () => {
			expect(messageContainsMention("Hello <@987654321>!", "123456789")).toBe(
				false,
			);
		});
	});
	...
	describe("buildMessageLink", () => {
		it("should build correct message link", () => {
			...
			expect(link).toBe(
				"https://discord.com/channels/guild123/channel456/msg789",
			);
		});
	});
	...
	describe("parseMessageLink", () => {
		...
		it("should return null for channel link without message", () => {
			expect(
				parseMessageLink("https://discord.com/channels/123456789/987654321"),
			).toBeNull();
		});

		it("should return null for non-numeric IDs", () => {
			expect(
				parseMessageLink("https://discord.com/channels/abc/def/ghi"),
			).toBeNull();
		});
	});
